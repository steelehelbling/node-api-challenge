...
I learned how to get the sever to work online and I learned how to use routers I also learned how backend workes with crud operations 

- [x] Describe Middleware?

Middleware is used when you type server.use(express.json()); Middleware functions allow you to take action on any incoming request and modify it before sending back a response. 

- [x] Describe a Resource?

All requests are a resource anywhere where you need to locate the request like /api and what they do is describe where and what operations it is performing like put, get, post, and delete

- [x] What can the API return to help clients know if a request was successful?

200 is the code that says it worked 201 is the code that you use when uploding a new item

- [x] How can we partition our application into sub-applications?

you can use routers and make it easyer to mange the files you just have to add 
server.use("/api/actions", actionRouter); actionRouter should = the new file you want to add
in the new file you just all the old stuff except router.use(express.json()); need to change from sever to router
